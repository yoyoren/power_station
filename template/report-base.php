        ...
        <div style="height:100%; overflow:auto; padding-right:20px; display:none;" id="show_table">
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <td class="th" colspan="19">时间：2015年02月01日 - 2015年02月28日</td>
            </tr>
            <tr>
              <td class="th" colspan="6">系统数据</td>
              <td class="th">&nbsp;</td>
              <td class="th" colspan="5">异常能耗修正值</td>
              <td class="th">归中</td>
              <td class="th">&nbsp;</td>
          ...
                     ② 70A+档位归中负载为该档位同建筑类型所有节能站的负载平均值(91.78A)
            ...
            <tr>
                <td colspan="23" class="leave-mes">中国联合网络通信有限公司上海分公司签字：</td>
            </tr>
            <tr>
                <td colspan="23" class="leave-mes">杉实环境科技（上海）有限公司签字：</td>
            </tr>
          </table>
        </div>
      </div>

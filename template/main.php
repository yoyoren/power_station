      ...
      <div class="clearfix" style="border-bottom:1px solid #eee;display:none">
        ...
        <div style="background:#fff; padding:20px; margin-top:20px;">
          ...
          <table class="table table-bordered tl-c">
            ...
            <tr>
              <th>砖墙</th>
             <td><a href="/base?building=2&energy=1"><?php echo $station_num_2[0]?></a></td>
            <td><a href="/base?building=2&energy=2"><?php echo $station_num_2[1]?></a></td>
            <td><a href="/base?building=2&energy=3"><?php echo $station_num_2[2]?></a></td>
            <td><a href="/base?building=2&energy=4"><?php echo $station_num_2[3]?></a></td>
            <td><a href="/base?building=2&energy=5"><?php echo $station_num_2[4]?></a></td>
            <td><a href="/base?building=2&energy=6"><?php echo $station_num_2[5]?></a></td>
            <td><a href="/base?building=2&energy=7"><?php echo $station_num_2[6]?></a></td>
            <td><a href="/base?building=2&energy=8"><?php echo $station_num_2[7]?></a></td>

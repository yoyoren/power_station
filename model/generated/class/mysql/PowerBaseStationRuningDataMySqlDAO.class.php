...
class PowerBaseStationRuningDataMySqlDAO implements PowerBaseStationRuningDataDAO{
	...
	public function insert($powerBaseStationRuningData){
		...
		$sqlQuery->set($powerBaseStationRuningData->workingStatus);
		$sqlQuery->set($powerBaseStationRuningData->deviceStatus1);
		$sqlQuery->set($powerBaseStationRuningData->deviceStatus2);
		$sqlQuery->set($powerBaseStationRuningData->deviceStatus3);
		$sqlQuery->set($powerBaseStationRuningData->deviceStatus4);
		$sqlQuery->set($powerBaseStationRuningData->deviceStatus5);
		$sqlQuery->set($powerBaseStationRuningData->deviceStatus6);
		$sqlQuery->set($powerBaseStationRuningData->deviceStatus7);
		$sqlQuery->set($powerBaseStationRuningData->deviceStatus8);
		$sqlQuery->set($powerBaseStationRuningData->deviceStatusFan);
		$sqlQuery->set($powerBaseStationRuningData->deviceStatusCabinet);
		$sqlQuery->set($powerBaseStationRuningData->deviceStatusVentilator);
		$sqlQuery->set($powerBaseStationRuningData->stationId);
		$sqlQuery->set($powerBaseStationRuningData->wetInside);
		$sqlQuery->set($powerBaseStationRuningData->wetOutside);
		$sqlQuery->set($powerBaseStationRuningData->ammeterNormal);
		$sqlQuery->set($powerBaseStationRuningData->ammeterSmart);
		$sqlQuery->set($powerBaseStationRuningData->overloadAc);
		$sqlQuery->set($powerBaseStationRuningData->overloadDc);
		$sqlQuery->set($powerBaseStationRuningData->temperatureInside);
		$sqlQuery->set($powerBaseStationRuningData->temperatureOutside);
		$sqlQuery->set($powerBaseStationRuningData->temperatureCabinet);
		$sqlQuery->set($powerBaseStationRuningData->temperatureAircondition1);
		$sqlQuery->set($powerBaseStationRuningData->temperatureAircondition2);
		$sqlQuery->set($powerBaseStationRuningData->temperatureAircondition3);
		$sqlQuery->set($powerBaseStationRuningData->temperatureAircondition4);
		$sqlQuery->set($powerBaseStationRuningData->temperatureAircondition5);
		$sqlQuery->set($powerBaseStationRuningData->temperatureAircondition6);
		$sqlQuery->set($powerBaseStationRuningData->temperatureAircondition7);
		$sqlQuery->set($powerBaseStationRuningData->temperatureAircondition8);
		$sqlQuery->set($powerBaseStationRuningData->createTime);
		
		//新增字段
		$sqlQuery->set($powerBaseStationRuningData->energyAll);
		$sqlQuery->set($powerBaseStationRuningData->energyDc);
		$sqlQuery->set($powerBaseStationRuningData->powerAll);
		$sqlQuery->set($powerBaseStationRuningData->powerDc);
